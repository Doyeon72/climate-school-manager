...
const ENERGY_CARD_SECTIONS = [
  {
    title: '월별 탄소 배출량은 학교생활의 흐름이에요',
    items: [
      '이 그래프는 실시간 사용량이 아니라, 경기기후플랫폼에서 제공되는 건물별 에너지 사용량 자료를 월별로 정리한 값이에요.',
      '한 해 동안의 탄소 배출량 흐름을 살펴보면서 어디서 탄소가 많이 배출되었을지 생각해 보아요.',
      '월별 탄소 배출량은 단순한 숫자가 아니라, 조명, 냉난방, 전자기기 사용이 모인 결과예요.',
      '이 숫자는 학교가 한 달 동안 활동한 흔적이자, 학교생활의 패턴을 보여주는 자료로 볼 수 있어요.',
      '같은 학교라도 계절, 날씨, 시간표, 행사 여부에 따라 월별 사용량은 달라질 수 있어요.',
  ...
  {
    title: '월별 숫자를 보고 학교 안에서 찾아봐요',
    items: [
      '전기를 많이 쓴 달에는 어떤 공간이나 활동에서 에너지가 더 필요했는지 살펴볼 수 있어요.',
      '숫자를 보는 것에서 끝나지 말고, 그 달에 냉난방, 특별실 사용, 학교 행사 등이 있었는지 함께 떠올려보세요.',
      '특정 달의 사용량이 높게 나왔다면 계절과 날씨, 냉난방 사용 기간을 함께 생각해보세요.',
      '사용량이 높게 보이는 달에는 학교 안에서 에너지가 많이 필요했을 만한 공간을 직접 찾아볼 수 있어요.',
      '에너지를 절약하는 가장 좋은 방법은 먼저 낭비되는 곳을 발견하는 거예요.',
      '월별 흐름을 살펴보면 낭비가 생기기 쉬운 공간과 습관을 더 구체적으로 찾을 수 있어요.',
    ],
  },
  {
